...
* **پیوست تصاویر کارگاهی**: امکان انتخاب و چیدمان خودکار تا ۴ تصویر مستندات روزانه در انتهای فایل PDF گزارش، به شکل کاملا متقارن و هوشمند.
* جدول‌بندی منظم فعالیت‌ها، تاخیرات ماشین‌آلات صنعتی، پرسنل فعال روزانه به تفکیک رده، مصالح وارده به کارگاه و اطلاعات جوی هوا.

### ۳. یکپارچگی هوشمند (هواشناسی و مدیریت کش تصاویر)
* **دریافت خودکار آب‌وهوا**: با وارد کردن نام شهر یا انتخاب از روی نقشه، سیستم به صورت آفلاین-آنلاین (ترکیب کش و شبکه) وضعیت دقیق آب‌وهوا را در زمان ثبت گزارش استخراج می‌کند.
* **مدیریت هوشمند تصاویر (Disk Cache)**: نگهداری آفلاین تصاویر انتخاب شده برای گزارش‌ها بدون اشغال حجم گالری گوشی تا مدت ۷ روز. سیستم به صورت خودکار تصاویر قدیمی‌تر را جهت مدیریت حافظه (حداکثر ۱۰۰ مگابایت) پاک‌سازی می‌کند.

### ۴. پنل داشبورد با خلاصه هوشمند کارها (Smart Sync)
